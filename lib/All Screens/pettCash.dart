...
class _PettyCashScreenState extends State<PettyCashScreen> {
  ...
  String validateBeforeSubmit() {
    if (item.text.isEmpty || itemPrice.text.isEmpty || mPesaMessage.text.isEmpty) {
      return "empty";
    } else {
      return "not empty";
    }
  ...
  updatePettyCashInDB() async{
    ...
    try {
      await databaseReference
          ...
          .child("$schoolName")
          .child("Petty Cash")
          .child(weekNumber.text.trim())
          .update({
        "item": item.text.toUpperCase().trim(),
              ...
              Padding(
                ...
                child: TextField(
                  ...
                  decoration: InputDecoration(
                    ...
                    label: Text(
                      "Term & Week Number (i.e 'Term 1 Week 1')",
